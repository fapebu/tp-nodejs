...
app.put('/libro/:id', async (req, res) => {
    try {
        ...
        if (!req.params.id.trim() || !req.body.nombre.trim() || !req.body.descripcion.trim() || !req.body.categoria_id || !req.body.persona_id) {
...
app.put('/libro/prestar/:id', async (req, res) => {
    try {
        if (!req.params.id.trim() || !req.body.persona_id) {
            throw new Error("error inesperdo")
        }
